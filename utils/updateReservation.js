...
async function updateReservation(id, reservationId, status, numberOfPeriods, reservationAmount, token, createdAt, contractURL) {
    ...
    try {
        ...
        await sql.query`
            ...
            SET 
                ...
                retorno_valor_liberado = ${reservationAmount},
                valor_digitacao = ${reservationAmount}, 
